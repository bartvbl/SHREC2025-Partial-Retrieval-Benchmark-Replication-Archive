...
config = {'dim': 32,                                            # descriptor output dimension
          ...
          'r_lrf': .5,                                          # LRF radius
          'fchkpt_gedi_net': 'chkpt.tar'}   # path to checkpoint
...
pcd0 = o3d.io.read_point_cloud('threed_match_7-scenes-redkitchen_cloud_bin_0.ply')
pcd1 = o3d.io.read_point_cloud('threed_match_7-scenes-redkitchen_cloud_bin_5.ply')
